export const services = [
  {
    ...
    imageSrc: "/images/services/子ども若者からの意見収集.jpg",
    accentTone: "mint" as const,
  },
  {
    title: "行政の先進事例やサービスを知りたい",
    description: "視察や現地ヒアリングの企画調整を通じて、学びの機会をつくります。",
    imageSrc: "/images/services/行政への研修.jpg",
    accentTone: "sky" as const,
  },
  {
    title: "専門家から専門知識を学びたい",
    description: "分野ごとの専門家とつながり、実務に活かせる学びを届けます。",
    imageSrc: "/images/services/専門家の講義.jpg",
    accentTone: "peach" as const,
  },
  {
    title: "地域密着の体験学習をしたい",
    description: "地域ならではの学びや現場体験を設計し、深い理解を促します。",
    imageSrc: "/images/services/体験型学習.jpg",
    accentTone: "lemon" as const,
  },
  {
    title: "社員研修や人材育成をしたい",
    description: "企業や団体に合わせた研修設計で、現場に活きる学びを支援します。",
    imageSrc: "/images/services/地域密着の研修.jpg",
    accentTone: "lavender" as const,
  },
];
