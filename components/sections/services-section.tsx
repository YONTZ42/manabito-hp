      ...
      <Container className="relative">
        ...
        <div className="mx-auto max-w-2xl text-center">
          ...
          <h2 className="mt-3 font-heading text-3xl font-bold text-text-main md:text-4xl">
            その悩み、<span className="key-phrase">マナビトが解決</span>します
          </h2>
          <p className="mt-4 text-base leading-relaxed text-text-sub">
            <span className="underline-brand font-semibold text-text-main">企画から運営まで、ワンストップで伴走。</span><br className="hidden sm:block" />
            あなたは本来の仕事に集中できます。
          </p>
        </div>
