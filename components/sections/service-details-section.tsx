...
function ServiceDetailCard({
  ...
  return (
    <div className="group relative flex flex-col rounded-3xl border border-base-border bg-white p-6 shadow-soft transition-all hover:border-brand/30 hover:shadow-strong md:p-8">
      ...
      <div className="mt-6">
        <span
          className="flex w-full cursor-not-allowed items-center justify-center rounded-full border border-base-border bg-base-border/30 px-4 py-2 text-sm font-medium text-text-sub/60"
        >
          準備中
        </span>
      </div>
